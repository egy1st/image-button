...
Namespace DynamicComponents
    Public Class ImageButton
        ...
        Public Sub InitForm(ByRef dm_Form As System.Windows.Forms.Form)
            ...
            '_ProductId = "ImageButton"
            '_ProductVersion = "V. 3.5"

            '_CompanyInfo = "Image Button V. 3.5" + vbCrLf
            '_CompanyInfo += "Powered by EgyFirst Software, Inc." + vbCrLf
            '_CompanyInfo += "Free 30 Days Trial Version"

            _buynow_URL = "hhttps://secure.avangate.com/order/checkout.php?PRODS=4699849&QTY=1&CART=1&CARD=1&ORDERSTYLE=nLWonZXfrnY="

            'MyProtect.SetProductKeys(_CompanyId, _ProductId, _ProductVersion)
            'MyProtect.SetAlgorithms(1971, 20, 35)
            ...
            Dim milliseconds As Long = CLng(DateTime.UtcNow.Subtract(New DateTime(1971, 1, 1)).TotalMilliseconds)
            If milliseconds Mod 24 = 0 Then
                MsgBox("This is a limited version of DC Image Button" + vbCrLf + "To get rid of this annoying message" + vbCrLf + "Buy full version from http://egy1st.com/image-button/")
                Exit Sub
            End If
